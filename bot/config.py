...
def load_config() -> Config:
    ...
    peresdacha = Tariff(
        ...
        title="VIP ОГЭ ПЕРЕСДАЧИ 2026",
        price=890.0,
        currency="RUB",
        duration="навсегда",
        description=(
            "✅Это VIP канал создан для тех кто не сдал ОГЭ с первого раза "
            "и пошел на пересдачу, подойдет для всех предметов на все регионы "
            "БЕЗ ДОПЛАТ, ответы здесь будут на все предметы и даты "
            "(29 июня, 2 июля, 3 июля, 6 июля)\n\n"
            "📌 Что в этом канале?\n"
            "- Шпаргалки на все предметы\n"
            "- Полные точные ответы ОГЭ по Всем предметам на оценку 4-5 "
            "(Все регионы и часовые пояса)\n"
            "- Решение второй части (по-возможности)\n"
